...
<div class="container pay">
    <div class="row">
        ...
        <div class="container pay-text">
            ...
            <p class="text-center">
                <img src="../Images/sup_carrt.PNG" alt="ABCs2">
            </p>
            <p>Quý khách chọn lấy một sản phẩm cần mua sau đó nhấn vào "Mua Ngay"</p>
            <p>
                <img src="../Images/sup_carrt1.PNG" alt="ABCs2">
            </p>
            ...
            <ul>
                ...
                <li>Những đơn hàng mà ABCmobile cho là không hợp lý cũng sẽ bị loại bỏ mà không cần báo trước.</li>
